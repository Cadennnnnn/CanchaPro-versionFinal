...
@Tag(
        name = "Canchas",
        description = "CRUD y administración de canchas deportivas"
)
public class CanchaController {
    ...
    @Operation(
            ...
            description = "Obtiene una cancha específica mediante su ID"
    )
    @GetMapping("/{id}")
    ...
    @Operation(
            ...
            description = "Filtra canchas por estado: DISPONIBLE, MANTENCION o INACTIVA"
    )
    ...
    @Operation(
            ...
            description = "Elimina físicamente una cancha por ID"
    )
    @DeleteMapping("/{id}")
    ...
    @Operation(
            ...
            description = "Actualiza únicamente el estado de una cancha"
    )
    ...
    @Operation(
            ...
            description = "Valida si una cancha existe y está en estado DISPONIBLE"
    )
