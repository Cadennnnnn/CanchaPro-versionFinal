...
@Tag(
        name = "Autenticación",
        description = "Endpoints para registro, login y validación JWT"
)
public class AuthController {
    ...
    @Operation(
            ...
            description = "Permite verificar si un token JWT es válido"
    )
    @GetMapping("/test")
    ...
    @Operation(
            ...
            description = "Permite probar autorización por rol ADMIN"
    )
    @GetMapping("/admin")
